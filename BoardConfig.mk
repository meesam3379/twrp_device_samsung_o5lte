...
TARGET_PREBUILT_KERNEL := device/samsung/o5lte/zImage
TARGET_PREBUILT_DTB := device/samsung/o5lte/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/o5lte/bootimg.mk
...
TARGET_INIT_VENDOR_LIB := libinit_o5lte
TARGET_RECOVERY_DEVICE_MODULES := libinit_o5lte
TARGET_LIBINIT_DEFINES_FILE := device/samsung/o5lte/init/init_o5lte.cpp
